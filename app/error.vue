                    ...
                    <div class="p-6 text-center">
                        ...
                        <div class="space-y-6">
                            <div v-if="maintenanceMessage"
                                ...
                                <h2 class="text-xl font-semibold mb-2 text-orange-600 dark:text-orange-400">{{
                                    t('maintenance.messageTitle') }}</h2>
                            ...
                            <div class="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                                <h2 class="text-xl font-semibold mb-2 text-blue-600 dark:text-blue-400">{{
                                    t('maintenance.whatToDo.title') }}</h2>
                    ...
                    <div class="p-6 text-center">
                        <div class="mb-8">
                            ...
                            <div v-if="errorImage" class="mb-6">
                                <img :src="errorImage" :alt="`Error ${props.error?.statusCode || 404}`"
                                    class="h-auto max-w-md mx-auto" width="400" loading="lazy" />
                            </div>

                            <!-- Error icon for non-404 errors -->
                            <div v-else class="mb-6">
                                <UIcon :name="getErrorIcon(props.error?.statusCode || 500)"
