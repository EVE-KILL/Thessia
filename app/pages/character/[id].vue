<template>
    <div class="min-h-screen">
        ...
        <div v-else-if="character" class="mx-auto p-4 text-gray-900 dark:text-white">
                            ...
                            <div class="character-info md:mr-6 mb-4 md:mb-0">
                                ...
                                <div class="affiliations space-y-2">
                                    <div class="flex items-center gap-2">
                                        <Image type="corporation" :id="character.corporation_id" class="w-6 h-6"
                                            size="64" />
                                    ...
                                    <div v-if="character.alliance_id && (character as any).alliance_name"
                                        ...
                                        <Image type="alliance" :id="character.alliance_id" class="w-6 h-6" size="64" />
                                    ...
                                    <div v-if="character.faction_id && (character as any).faction_name"
                                        class="flex items-center gap-2">
                                        <Image type="corporation" :id="character.faction_id" class="w-6 h-6"
                                            size="64" />
