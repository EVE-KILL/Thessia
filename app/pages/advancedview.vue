    ...
    <div class="min-h-screen text-white">
        <UContainer class="py-8">
            ...
            <div class="flex items-center mb-6">
                <UButton variant="ghost" color="gray" icon="i-lucide-arrow-left" @click="goBackToSearch" class="mr-4">
                    Back to Search
                </UButton>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-5 gap-8">
                    ...
                    <div class="xl:col-span-4 space-y-8">
                        ...
                        <template v-else-if="stats?.mostValuableKills && stats.mostValuableKills.length > 0">
                            ...
                            <AdvancedMostValuable title="" :items="stats.mostValuableKills" :loading="false" />
                        </template>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <template v-else-if="killmails.length > 0">
                                    <KillList :externalKilllistData="killmails" :limit="currentLimit"
                                        :enablePagination="true" :currentPage="currentPage" :totalPages="totalPages"
                                        @update:page="handlePageChange" @update:limit="handleLimitChange" wsDisabled />
                                </template>
                                <template v-else>
                    ...
                    <div class="xl:col-span-1 space-y-6">
                        <!-- Top Killers -->
                        <CampaignTopBox title="Top Killers" :entities="stats?.topKillersByCharacter || []"
                            countField="kills" entityType="character" :loading="isStatsLoading" />

                        <!-- Top Victims -->
                        <CampaignTopBox title="Top Victims" :entities="stats?.topVictimsByCharacter || []"
                            countField="losses" countTitle="Losses" entityType="character" :loading="isStatsLoading" />

                        <!-- Top Damage Dealers -->
                        <CampaignTopBox title="Top Damage Dealers" :entities="stats?.topDamageDealersByCharacter || []"
                            countField="damageDone" countTitle="Damage" entityType="character"
                            :loading="isStatsLoading" />

                        <!-- Top Corporations -->
                        <CampaignTopBox title="Top Corporations" :entities="stats?.topKillersByCorporation || []"
                            countField="kills" entityType="corporation" :loading="isStatsLoading" />

                        <!-- Top Alliances -->
                        <CampaignTopBox title="Top Alliances" :entities="stats?.topKillersByAlliance || []"
                            countField="kills" entityType="alliance" :loading="isStatsLoading" />
                    </div>
                </div>
            </div>
        </UContainer>
