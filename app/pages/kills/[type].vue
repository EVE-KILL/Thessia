...
const allowedTypes = [
    'latest', 'abyssal', 'wspace', 'highsec', 'lowsec', 'nullsec', 'pochven', 'jove', 'big', 'solo', 'npc',
...
const killlistTypeToFilters: Record<string, Record<string, any>> = {
    ...
    jove: { region_id: { $in: [10000004, 10000017, 10000019] } },
...
const shipStatsTypes = [
    'latest', 'abyssal', 'wspace', 'highsec', 'lowsec', 'nullsec', 'pochven', 'jove', 'big', 'solo', 'npc', '5b', '10b'
]

// Types that should show most valuable kills (all except very specific ship types)
const mostValuableKillsTypes = [
    'latest', 'abyssal', 'wspace', 'highsec', 'lowsec', 'nullsec', 'pochven', 'jove', 'big', 'solo', 'npc', '5b', '10b', 'citadels'
]
