 ...
 */
export const useDefaultTab = (pageType: 'character' | 'corporation' | 'alliance', availableTabs: Array<{ id: string }>) => {
    ...
    const getDefaultTabId = (): string => {
        ...
        if (userPreferredTab && availableTabs.some(tab => tab.id === userPreferredTab)) {
