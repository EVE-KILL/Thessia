                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div class="relative">
                                        <Image type="system" :id="connection.destination_system_id"
                                            class="w-10 h-10 rounded-lg shadow-sm" size="64" />
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 bg-blue-500 rounded-full border-2 border-white dark:border-gray-800 flex items-center justify-center">
                    ...
                    <div v-for="(neighbor, index) in system.neighboring_systems" :key="neighbor.system_id"
                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div class="relative">
                                        <Image type="system" :id="neighbor.system_id"
                                            class="w-10 h-10 rounded-lg shadow-sm" size="64" />
                        ...
                        <!-- Hover effect overlay -->
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-green-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 pb-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400 ml-2">({{
                        system?.celestials?.length || 0 }} objects)</span>
                </h3>
            </div>
                    ...
                    <div class="p-3">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <div
                                    class="font-medium text-gray-900 dark:text-white text-sm truncate group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-200">
                                    {{ celestial.item_name }}
                                </div>
