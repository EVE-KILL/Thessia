                    ...
                    <UPopover mode="hover" :popper="{ placement: 'top' }">
                        <div class="space-y-2 cursor-help">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    v-if="(item as any).newItemsCount !== undefined && (item as any).newItemsCount !== null"
                                    :class="[
                            ...
                            <div class="p-3 max-w-xs">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-white">{{ (item as
                                            any).itemsReturned || 0 }}</span>
                                    </div>
                                ...
                                <div v-else
                                    class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-600 text-sm text-gray-500 dark:text-gray-400">
