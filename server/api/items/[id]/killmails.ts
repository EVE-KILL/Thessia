...
export default defineCachedEventHandler(
    async (event) => {
        try {
            ...
            // Define the query condition based on whether the item is a ship
            let queryCondition = {};
            ...
            // Get optimal index hint using the indexOptimizer
            ...
            let killmailQuery = Killmails.find(
                queryCondition,
                {
                    _id: 0,
                    killmail_id: 1,
            ...
            const killmails = await killmailQuery.lean();
