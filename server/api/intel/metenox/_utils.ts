 ...
 */
export function classifyGoos(killmail: any): Record<string, number> {
    const gooTypes = {
        R4: [
            "Hydrocarbons",
            "Silicates",
        ...
        R8: ["Cobalt", "Scandium", "Tungsten", "Titanium"],
        R16: ["Chromium", "Cadmium", "Platinum", "Vanadium"],
        R32: ["Technetium", "Mercury", "Caesium", "Hafnium"],
        R64: ["Promethium", "Neodymium", "Dysprosium", "Thulium"],
    };
 ...
 */
export async function getMetenoxMoons(
    systemId?: number | null,
    regionId?: number | null
): Promise<IMetenoxMoonResult[]> {
    // Metenox Refinery ID
