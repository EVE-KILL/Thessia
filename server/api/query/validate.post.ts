...
export default defineEventHandler(async (event: H3Event) => {
    ...
    if (fieldValues["region_id"] && fieldValues["system_id"]) {
        ...
        if (
            SYSTEM_TO_REGION[systemId] &&
            SYSTEM_TO_REGION[systemId] !== regionId
        ) {
            warnings.push(
                `System ${systemId} does not belong to the selected region ${regionId}.`
            );
        }
    }
    ...
    if (fieldValues["constellation_id"] && fieldValues["system_id"]) {
        ...
        if (
            SYSTEM_TO_CONSTELLATION[systemId] &&
            SYSTEM_TO_CONSTELLATION[systemId] !== constellationId
        ) {
            warnings.push(
                `System ${systemId} does not belong to the selected constellation ${constellationId}.`
            );
        }
    }
    ...
    if (fieldValues["region_id"] && fieldValues["constellation_id"]) {
        ...
        if (
            CONSTELLATION_TO_REGION[constellationId] &&
            CONSTELLATION_TO_REGION[constellationId] !== regionId
        ) {
            warnings.push(
                `Constellation ${constellationId} does not belong to the selected region ${regionId}.`
            );
        }
    }
    ...
    if (
        fieldValues["victim.character_id"] &&
        fieldValues["victim.corporation_id"]
    ) {
        ...
        if (CHAR_TO_CORP[charId] && CHAR_TO_CORP[charId] !== corpId) {
            warnings.push(
                `Victim character ${charId} does not belong to the selected corporation ${corpId}.`
            );
        }
    }
    ...
    if (
        fieldValues["victim.corporation_id"] &&
        fieldValues["victim.alliance_id"]
    ) {
        const corpId = Number(fieldValues["victim.corporation_id"]);
        ...
        if (
            CORP_TO_ALLIANCE[corpId] &&
            CORP_TO_ALLIANCE[corpId] !== allianceId
        ) {
            warnings.push(
                `Victim corporation ${corpId} does not belong to the selected alliance ${allianceId}.`
            );
        }
    }
    ...
    if (
        ...
        if (
            CHAR_TO_ALLIANCE[charId] &&
            CHAR_TO_ALLIANCE[charId] !== allianceId
        ) {
            warnings.push(
                `Victim character ${charId} does not belong to the selected alliance ${allianceId}.`
            );
        }
    }
    ...
    if (
        fieldValues["attackers.character_id"] &&
        fieldValues["attackers.corporation_id"]
    ) {
        ...
        if (CHAR_TO_CORP[charId] && CHAR_TO_CORP[charId] !== corpId) {
            warnings.push(
                `Attacker character ${charId} does not belong to the selected corporation ${corpId}.`
            );
        }
    }
    ...
    if (
        fieldValues["attackers.corporation_id"] &&
        fieldValues["attackers.alliance_id"]
    ) {
        const corpId = Number(fieldValues["attackers.corporation_id"]);
        ...
        if (
            ...
            warnings.push(
                `Attacker corporation ${corpId} does not belong to the selected alliance ${allianceId}.`
            );
        }
    }
    ...
    if (
        ...
        if (CORP_TO_FACTION[corpId] && CORP_TO_FACTION[corpId] !== factionId) {
            warnings.push(
                `Victim corporation ${corpId} does not belong to the selected faction ${factionId}.`
            );
        }
    }
    ...
    if (fieldValues["victim.alliance_id"] && fieldValues["victim.faction_id"]) {
        ...
        if (
            ALLIANCE_TO_FACTION[allianceId] &&
            ALLIANCE_TO_FACTION[allianceId] !== factionId
        ) {
            warnings.push(
                `Victim alliance ${allianceId} does not belong to the selected faction ${factionId}.`
            );
        }
    }
