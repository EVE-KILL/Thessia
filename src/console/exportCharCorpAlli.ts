...
export default {
  ...
  run: async () => {
    ...
    fs.writeFileSync(path.join(__dirname, "~/server/data/characters.json"), "[");
    let firstChar = true;
    ...
    fs.writeFileSync(path.join(__dirname, "~/server/data/corporations.json"), "[");
    let firstCorp = true;
    ...
    fs.writeFileSync(path.join(__dirname, "~/server/data/alliances.json"), "[");
    let firstAlli = true;
