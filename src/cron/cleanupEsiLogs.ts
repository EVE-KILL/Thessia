...
export default {
    name: "cleanupEsiLogs",
    description: "Clean up ESI logs older than 30 days to prevent database bloat",
    ...
    run: async () => {
        ...
        try {
            ...
            cliLogger.info(`Successfully deleted ${result.deletedCount} ESI logs older than 30 days`);
