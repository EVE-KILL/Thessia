    ...
    <div class="grid grid-cols-3 gap-3">
      ...
      <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-3">
        <div class="flex items-center justify-between mb-2">
          ...
          <select
            :value="filters.entities.victimOperator"
        ...
        >
          <div
            v-for="entity in victimEntities"
            :key="entity.id"
            draggable="true"
      ...
      <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-3">
        <div class="flex items-center justify-between mb-2">
          ...
          <select
            :value="filters.entities.bothOperator"
      ...
      <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-3">
        <div class="flex items-center justify-between mb-2">
          ...
          <select
            :value="filters.entities.attackerOperator"
        ...
        >
          <div
            v-for="entity in attackerEntities"
            :key="entity.id"
            draggable="true"
            @dragstart="onDragStart($event, entity)"
            class="flex items-center justify-between p-1.5 bg-zinc-700 rounded cursor-move hover:bg-zinc-600 transition-colors"
