<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <ButtonGroup
        v-model="filters.killType"
        :options="killTypeOptions"
        multiple
        class="grid grid-cols-2 gap-2"
      />
    </div>
    ...
    <div>
      ...
      <ButtonGroup
        v-model="filters.iskValue"
        :options="iskValueOptions"
        multiple
        class="grid grid-cols-2 gap-2"
      />
    </div>
