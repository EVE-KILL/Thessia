  ...
  return [
    {
      ...
      children: [
        ...
        {
          name: 'Holder',
          description: 'Another placeholder link',
          url: '#',
          disabled: false
        }
      ]
    ...
    <div class="flex items-center space-x-2">
      <template v-for="(link, index) in leftNavItems" :key="index">
        ...
        >
          <template #trigger>
            <div
              class="flex items-center py-1.5 px-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800
                    transition-colors cursor-pointer text-gray-700 dark:text-gray-200"
              :title="link.label"
            >
          ...
          <div class="py-1 min-w-[240px]">
            <div class="py-1">
              <a
                v-for="(item, itemIndex) in link.children"
                :key="itemIndex"
                :href="item.url"
                target="_blank"
              ...
              >
                <div class="flex flex-col">
                  ...
                  <span v-if="item.description" class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate max-w-[200px]">
                    {{ item.description }}
                  </span>
                </div>
              </a>
