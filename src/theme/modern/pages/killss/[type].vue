...
import KillsMostValuable from '~/src/theme/modern/components/kills/KillsMostValuable.vue';
import KillsShipStats from '~/src/theme/modern/components/kills/KillsShipStats.vue';
import KillsTopBox from '~/src/theme/modern/components/kills/KillsTopBox.vue';
