<template>
    ...
    <div v-if="!isMobile" class="flex flex-wrap mt-4 gap-4">
                    ...
                    <div class="w-full flex justify-center items-center">
                        <template v-if="!killmail || isLoading">
                            <div class="fitting-wheel-skeleton max-w-[650px]">
                                ...
                                <div v-for="i in 8" :key="`high-${i}`" :style="getSkeletonSlotPosition(i - 1, 8, 'top')"
                                ...
                                <div v-for="i in 3" :key="`rig-${i}`" :style="getSkeletonSlotPosition(i - 1, 3, 'left')"
        ...
        <div
            ...
            <UTabs v-else :items="rightSideTabs" :ui="tabsUi" v-model="defaultDesktopTabIndex" color="neutral">
...
const { data: battleStatus } = useAsyncData<{ inBattle: boolean }>(
