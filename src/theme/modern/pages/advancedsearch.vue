    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="bg-zinc-900 border border-zinc-700 rounded-lg p-6 mb-6">
        <div class="mb-4 relative">
          ...
          <div
            v-if="showSearchResults && (searchResults.length > 0 || searchLoading)"
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  v-else-if="isItemType(result.type)"
                  @click.stop="addItemToFilter(result)"
            ...
            <!-- No results -->
            <div v-if="!searchLoading && searchResults.length === 0 && searchTerm.length > 2" class="p-3 text-center text-zinc-400">
              No results found
            </div>
          </div>
        </div>
        ...
        <div v-if="facets.length > 0" class="flex flex-wrap gap-2">
          ...
          >
            ...
            <button
              ...
              class="ml-2 hover:bg-blue-700 rounded-full p-1"
            >
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div class="lg:col-span-1">
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-3 max-h-72 overflow-y-auto">
              <pre class="text-xs text-zinc-200 font-mono whitespace-pre-wrap">{{ formattedQueryWithoutProjection }}</pre>
            </div>
          </div>
          ...
          <div class="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
              ...
              <div v-if="filters.location.type && filters.location.value" class="mb-2">
                <div class="inline-flex items-center bg-green-600 text-white text-sm px-3 py-1 rounded-full">
                  <span>{{ filters.location.type.charAt(0).toUpperCase() + filters.location.type.slice(1) }}: {{ filters.location.value }}</span>
                  <button
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
              ...
              <div class="flex flex-wrap gap-1">
                <button
                  v-for="option in attackerCountOptions"
                  :key="option.value"
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
              ...
              <div class="flex flex-wrap gap-1">
                <button
                  v-for="option in attackerTypeOptions"
                  :key="option.value"
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
              ...
              <div class="flex flex-wrap gap-1">
                <button
                  v-for="option in iskValueOptions"
                  :key="option.value"
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
              ...
              <div class="flex flex-wrap gap-1">
                <button
                  v-for="option in shipCategoryOptions"
                  :key="option.value"
            ...
            <div class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
              ...
              <div class="space-y-2">
                <div>
                  ...
                  <input
                    v-model="filters.customTimeRange.from"
                    @input="clearTimeFilterOnCustomInput"
                    type="datetime-local"
                ...
                <div>
                  ...
                  <input
                    v-model="filters.customTimeRange.to"
                    @input="clearTimeFilterOnCustomInput"
                    type="datetime-local"
                    class="w-full px-2 py-1 text-xs bg-zinc-700 border border-zinc-600 rounded text-zinc-100 focus:border-blue-500 focus:outline-none"
                    placeholder="YYYY-MM-DD HH:mm:ss"
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                :class="getFilterButtonClass(sortField === option.value)"
          ...
          <div>
            ...
            <div class="flex gap-2">
              <button
                ...
                :class="getFilterButtonClass(sortDirection === 'desc')"
                class="text-sm px-3 py-2"
              >
                Descending
              </button>
              <button
                ...
                :class="getFilterButtonClass(sortDirection === 'asc')"
                class="text-sm px-3 py-2"
              >
                Ascending
              </button>
      ...
      <div v-if="queryResult !== null" class="mt-8">
        <div class="bg-zinc-900 border border-zinc-700 rounded-lg p-6">
          ...
          <div v-if="queryResult && queryResult.length > 0" class="bg-zinc-800 border border-zinc-600 rounded-lg p-4">
            <KillList
              :externalKilllistData="transformedQueryResult"
              :limit="25"
...
import EntityFilter from '~/src/theme/modern/components/advancedsearch/EntityFilter.vue'
import KillList from '~/src/theme/modern/components/common/KillList.vue'
import Image from '~/src/theme/modern/components/common/Image.vue'
import type {
  AdvancedSearchFilters,
  SearchFacet
} from '~/src/theme/modern/helpers/advancedsearch'
import {
