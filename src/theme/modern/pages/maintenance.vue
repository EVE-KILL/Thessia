            ...
            <div class="p-6 text-center">
                ...
                <div class="space-y-6">
                    <div v-if="maintenanceMessage" class="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
                        <h2 class="text-xl font-semibold mb-2 text-orange-400">{{ t('maintenance.messageTitle') }}</h2>
                        <p class="text-gray-200 dark:text-gray-300">{{ maintenanceMessage }}</p>
                    </div>

                    <div class="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                        <h2 class="text-xl font-semibold mb-2 text-blue-400">{{ t('maintenance.whatToDo.title') }}</h2>
                        <ul class="text-left text-gray-200 dark:text-gray-300 space-y-2">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-600 pt-4">
